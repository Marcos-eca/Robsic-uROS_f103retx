...
#define PB0_EXTI_IRQn EXTI0_IRQn
#define ROS_USART_TX_Pin GPIO_PIN_2
#define ROS_USART_TX_GPIO_Port GPIOA
#define ROS_USART_RX_Pin GPIO_PIN_3
...
#define GPS_USART_RX_Pin GPIO_PIN_2
#define GPS_USART_RX_GPIO_Port GPIOD
#define GPS_USART_TX_Pin GPIO_PIN_12
